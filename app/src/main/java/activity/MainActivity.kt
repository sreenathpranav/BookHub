...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var navigatonView: NavigationView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navigatonView = findViewById(R.id.navigationView)
        ...
        navigatonView.setNavigationItemSelectedListener {
    ...
    fun openDashboard() {
        ...
        navigatonView.setCheckedItem(R.id.dashboard)
    }
